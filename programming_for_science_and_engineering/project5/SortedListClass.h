...
//tingjie yu
//date: 11/14/2021
//purpose of code: header files for sortedlistsclass
...
public:
  ...
  void insertValue(
    const NODETYPE &valToInsert);//The value to insert into the list
  ...
  bool removeFront(NODETYPE &theVal);
  ...
  //removed, true is returned, and the reference parameter will
  //be set to the item that was removed.
  bool removeLast(NODETYPE &theVal);
  ...
  bool getElemAtIndex(
    const int index, NODETYPE &outVal) const;
