...
//tingjie yu
//date: 11/14/2021
//purpose of code: header file for LinkedNodeClass
////define linkednode
//The list node class will be the data type for individual nodes of
//a doubly-linked data structure

#ifndef _LINKEDNODECLASS_TEMPLATE_H_
#define _LINKEDNODECLASS_TEMPLATE_H_

template < class NODETYPE >
class LinkedNodeClass {
private:
  LinkedNodeClass<NODETYPE> *prevNode; 
  ...
  LinkedNodeClass<NODETYPE> *nextNode; 
...
public:
  ...
  LinkedNodeClass<NODETYPE>* getNext() const;


  //Returns the address of the node that comes before this node.
  LinkedNodeClass<NODETYPE>* getPrev() const;
